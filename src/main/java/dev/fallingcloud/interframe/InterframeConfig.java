 ...
 *
 * <p>Fields are plain so GSON (de)serialises them directly and the Sodium option bindings can read/write
 * them with simple getters/setters (mirrors Foveate's config layout).
 */
public class InterframeConfig {
    ...
    private static Path file() {
        return FabricLoader.getInstance().getConfigDir().resolve("interframe.json");
    }
