 ...
 *
 * <p>Fields are plain so GSON (de)serialises them directly and {@link dev.fallingcloud.interframe.client.InterframeConfigScreen}
 * can read/write them with simple getters/setters.
 */
